        ...
        <body class="bg-six">
            ...
            <div class="container">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <s:iterator value="listaReporte">
                            <tr>
                                <th class="d-lg-block d-md-none d-none" scope="row"><s:property value="idReporte"></s:property></th>
                                <td><s:property value="reportado.nombre"></s:property></td>
                                <td id="categoryInput"><s:property value="categoria"></s:property></td>
                                <td id="issueValue"><s:property value="asunto"></s:property></td>
                                    <td>
                                    <s:form method="post" action="eliminarReporte">
                                        <s:textfield name="idReporte"
                                                     value="%{idReporte}"
                                    ...
                                    <img src="img/icons/pencil.svg" class="openReportingModal clickable" />
                                </td>
                                </form>
                            </tr>
                        </s:iterator>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <s:form action="editarReporte"  method="post">
                                <div class="row modal-form">
                                    <s:textfield name="idReporte"
                                                 value="%{idReporte}"
                                                 hidden="true"></s:textfield>
                                        <label class="col-12 p-0 m-0" for="category">Category</label>
                                        <select id="categoryInput" name="categoryInput" class="col-12 m-0 mb-2 mt-1 form-control">
                                            <option value="Otros">Other</option>
                                        </select>
                                        <label class="col-12 p-0 m-0" for="issue">Explain your issue</label>
                                    <s:textarea id="issueInput" cssClass="col-12 mb-2 mt-1 form-control" name="issueInput"></s:textarea>
            ...
            <script typw="text/javascript">
                $('.openReportingModal').on('click', function () {
                    ...
                    var issue = $(this).closest('tr').find($("#issueValue")).text();
                    var category = $(this).closest('tr').find($("#categoryValue")).text();

                    $('.modal-form').find("input[name='idReporte']").val(id);
                    $("#categoryInput").val(category);
                    $("#issueInput").val(issue);
